...
#define DAYCARE_HACK_FLAG_BREEDER_CHECKED  0x2
#define DAYCARE_MAX_BATTLES_PER_DAY       3
// Daycare_BreederCheck VAR_RESULT codes
#define DAYCARE_BREEDER_NOTHING           0
#define DAYCARE_BREEDER_EGG_FOUND         1
#define DAYCARE_BREEDER_NO_MON            2
#define DAYCARE_BREEDER_ALREADY_CHECKED   3
#define DAYCARE_BREEDER_EGG_WAITING       4
#define DAYCARE_BREEDER_CONDOM_BLOCKED    5
